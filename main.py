from classes.classes import JSONFileInterface, HH, HHVacancy, SJ, SJVacancy
from utils.utils import user_input_for_request, add_json, user_menu_loaded, create_collection_from_file, \
